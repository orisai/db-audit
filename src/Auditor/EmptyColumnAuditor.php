...
abstract class EmptyColumnAuditor implements Analyser, SchemaRequesting
{
	...
	/**
	 * Every nullable or string column of every base table is checked for row data, so table metadata is
	 * needed for the base-table list; no statistics and no exclude-driven scope expansion.
	 */
