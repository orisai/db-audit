...
abstract class EmptyTableAuditor implements Analyser, SchemaRequesting
{
	...
	/**
	 * Every base table is probed for a row, so table metadata is needed for the base-table list; no statistics
	 * and no exclude-driven scope expansion.
	 */
