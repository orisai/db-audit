...
abstract class BoolLikeColumnAuditor implements Analyser, SchemaRequesting
{
	...
	/**
	 * Every integer column of every base table is checked for bool-like data, so table metadata is needed for
