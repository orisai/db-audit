...
abstract class NullableWithNoNullsAuditor implements Analyser, SchemaRequesting
{
	...
	/**
	 * Nullable columns of every base table are checked for NULL-free data, so table metadata is needed for the
	 * base-table list; no statistics and no exclude-driven scope expansion.
	 */
