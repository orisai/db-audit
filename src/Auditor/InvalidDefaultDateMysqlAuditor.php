...
final class InvalidDefaultDateMysqlAuditor extends InvalidDefaultDateAuditor
{
	...
	public function analyse(): AnalysisResult
	{
		...
		foreach ($records as $record) {
			...
			$violations[] = new Violation('invalid_default_date', $message, $source);
		}
...
WHERE c.TABLE_SCHEMA = DATABASE()
	...
	AND (
		-- zero year, anchored to the start of the date (MariaDB quotes the stored default, MySQL does not)
		c.COLUMN_DEFAULT LIKE '0000-%'
		OR c.COLUMN_DEFAULT LIKE '''0000-%'
